...
export function buildToolbarModel(state) {
  ...
  return {
    tools: [
      ...
      { id: 'highlight', label: '螢光標示', icon: '▌', active: selectedTool === 'highlight', disabled: !hasDoc },
      ...
      { id: 'circle', label: '圓形', icon: '○', active: selectedTool === 'circle', disabled: !hasDoc },
      { id: 'line', label: '線段', icon: '╱', active: selectedTool === 'line', disabled: !hasDoc },
      { id: 'arrow', label: '箭頭', icon: '↗', active: selectedTool === 'arrow', disabled: !hasDoc },
      { id: 'stamp', label: '印章', icon: '⊕', active: selectedTool === 'stamp', disabled: !hasDoc },
      { id: 'signature', label: '電子簽署', icon: '✍', active: selectedTool === 'signature', disabled: !hasDoc },
    ],
